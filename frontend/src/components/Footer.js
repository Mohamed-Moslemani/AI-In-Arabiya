        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/" className="hover:text-blue-200 transition duration-300">الصفحة الرئيسية</Link></li>
              <li><Link to="/login" className="hover:text-blue-200 transition duration-300">تسجيل الدخول</Link></li>
              <li><Link to="/signup" className="hover:text-blue-200 transition duration-300">التسجيل</Link></li>
            </ul>
          </div>
